...
define("REMOTE_REPOSITORY", "git@github.com:anhhao135/website.git"); // The SSH URL to your repository
...
define("AFTER_PULL", "echo "pull successful"");                                              // A command to execute after successfully pulling
